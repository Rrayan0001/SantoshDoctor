...
export default function TestimonialCard({ text, name, tag }: TestimonialCardProps) {
  return (
    <div className="relative bg-white p-8 rounded-card shadow-card hover:shadow-2xl transition-all duration-300 flex flex-col justify-between overflow-hidden">
